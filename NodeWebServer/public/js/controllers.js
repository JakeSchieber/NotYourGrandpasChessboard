...
.controller('GameCtrl', function($scope, Socket, $rootScope) {
  /* Dont need these @ the moment
  var board1 = ChessBoard('board1', {
    ...
    snapbackSpeed: 500,
    snapSpeed: 100,
    onChange: onChange // board position is not updated by the time onChange is called.
  });

  // we should never set board2. Board set should automatically be set by the current server on load.
